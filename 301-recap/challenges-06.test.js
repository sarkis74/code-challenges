...
//       // Solution code here...
//       for(var i in arr) {
//         temp = (Object.values(arr[i]))
//         if(character == temp[0] && temp[2].length != 0) {
//           return true;
//           }
//           else if(character == temp[0] && temp[2].length == 0) {
//             return false;
//           }
//         }
//       }
...
//         if(character == temp[0][1] && temp[2][1].length != 0) {
//           return true;
//           }
//           else if(character == temp[0][1] && temp[2][1].length == 0) {
//             return false;
//           }
//         }
//       }
